...
// By default, we fold every ul that is not the top one
const foldAll = () => {
    div = document.getElementById('word-lists-panel')
    baseul = div.children[0]
    toHide = baseul.getElementsByTagName('ul')
