...
func initFrenchTranslation() Translation {
	...
	translation.put("custom-words-info", "Indiquez vos mots personnalisés, séparés par des virgules")
	translation.put("custom-words-per-turn-setting", "Nombre de mots personalisés par tour")
